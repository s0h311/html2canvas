...
var oklch = function (context, args) {
    ...
    var l = length_percentage_1.isLengthPercentage(lightness) ? lightness.number / 100 : 0;
    var c = length_percentage_1.isLengthPercentage(chroma) ? chroma.number / 100 : 0;
    var h = hue.type === 17 /* NUMBER_TOKEN */ ? angle_1.deg(hue.number) : angle_1.angle.parse(context, hue);
    var a = typeof alpha !== 'undefined' && length_percentage_1.isLengthPercentage(alpha) ? length_percentage_1.getAbsoluteValue(alpha, 1) : 1;
    ...
    var b = lr + y * 1.73205;
    return exports.pack(clamp(r, 0, 255), clamp(g, 0, 255), clamp(b, 0, 255), a);
};
